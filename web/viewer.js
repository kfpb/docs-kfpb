...
function getViewerConfiguration() {
  return {
    ...
    toolbar: {
      ...
      openFile: document.getElementById('presentationMode'),
      print: document.getElementById('presentationMode'),
      presentationModeButton: document.getElementById('presentationMode'),
      download: document.getElementById('presentationMode'),
    ...
    secondaryToolbar: {
      ...
      printButton: document.getElementById('secondaryOpenFile'),
      downloadButton: document.getElementById('secondaryOpenFile'),
