...
header("Content-Disposition: attachment; filename=Data_Export_PR.xls");
    ?>
<div class="span12">
	...
	<?php
		...
		echo"<td width=5%>";echo tgl_indo($s[sitgl]);echo"</td>
				  <td><font size=2>$s[siperihal], <b>Note User :</b>$s[sikomen]</font></td>
				  <td>No. Order/PR :$s[jenispptek]</td><td>";
