<div class="navbar navbar-inner block-header">
	<div class="muted pull-left">Tindaklanjuti Reminder/Pengingat (Perizinan, Sertifikat, Pelatihan, Umum & K3L dan Lainnya)</div>
</div>
...
$ee = mysql_fetch_array(mysql_query("SELECT * FROM reminder2 WHERE dNoagenda='$e[pNoagenda]' AND iid=$_GET[id]")); 
	...
	echo"
	<tr><td>Jenis Perizinan/Sertifikasi </td><td>: $e[pJudul]</td></tr>
...
<div class="span12">
	...
	<thead>
		<tr><th width=1%></th>
			...
			<th>Jenis & Keterangan Reminder</th>
    ...
    $tambah_tahun = mktime(0,0,0,date('Y')-3);
    $tambah3 = date('Y-m-d',$tambah_tanggal);
...
//$dsp = mysql_query("SELECT a.*,b.cNama, b.cIdjab FROM premind a LEFT JOIN users b ON a.pid=b.cId WHERE a.cId='$_SESSION[cv]' AND a.siid=0 ORDER BY a.ptgl DESC");
