<div class="navbar navbar-inner block-header">
	<div class="muted pull-left"><font color=black>Memo/Undangan Masuk Internal untuk Anda</font></div>
</div>
...
<strong>
<legend>Detail Memo/Undangan Internal untuk Anda</legend>
...
<div class="span12">
	...
	<tbody>
	<?php
		$smasuk = mysql_query("SELECT a.*,b.*,c.cIdjab, c.cJabatan FROM sinter a LEFT JOIN psin b ON a.siid=b.siid LEFT JOIN users c ON a.sipengirim2=c.cId  WHERE b.cId='$_SESSION[cv]' && a.sstatus='Y' ORDER BY a.sitgl DESC");
			
		while($s = mysql_fetch_array($smasuk)) {
		if ($s[jenisms]!='20' AND $s[jenisms]!='33'){
		if ($s[sistatus]=='N'){
		...
		echo"<td width=5%>";echo tgl_indo($s[sitgl]);echo"</td>
				...
				echo"</td>
				<td width=5%><a href='home.php?pages=usrt&act=detail&id=$s[siid]' title=DetailMemo class='btn btn-info'>Baca!</a></td>
				</tr>";	
		}
		}
	?>
