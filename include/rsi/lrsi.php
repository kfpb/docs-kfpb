...
?>
	<div id="print">
		...
		<tr>
			...
			echo "<h3>LAPORAN SURAT INTERNAL</h3>";
			...
			echo "<table border='1'>
				...
				$qsm = mysql_query("SELECT a.sinmr, a.sitgl, b.cNama, a.siperihal 
									FROM sinter a 
									LEFT JOIN users b ON a.sipengirim=b.cId
									WHERE a.sitgl>='$_POST[tglm]' AND a.sitgl<='$_POST[tgls]'");
