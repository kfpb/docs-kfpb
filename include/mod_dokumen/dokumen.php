...
$aksi="../../bdg/include/mod_dokumen/aksi_dokumen.php";
$aksis="../../bdg/include/mod_dokumen/dokumen.php";
$aksi1="../../bdg/include/mod_upd/aksi_upd.php";
$aksi2="../../bdg/include/mod_pcopy/aksi_copy.php";
switch($_GET[act]){
   default:
       echo "<h3>Registrasi Dokumen Internal</h3>";
   		  // Form Pencarian Dokumen Judul

    if ($_SESSION[leveluser]=='Admin'){		 
// Tambah dokumen
    echo "<font size=2><b><u><font color=blue style='background-color:#FFFFFF'>Tambah Database Dokumen Manual : </font></u></b></font><input type=button value='Klik Disini' onclick=\"window.location.href='?pages=dokint&act=tambahdokumen';\"><br>
...
<font size=2>Berdasarkan kata kunci <b>Judul/ Kode Dokumen :</b></font>
      <form target=_blank method=POST action='$aksi?module=dokumen&act=caridokumen'>    
        <input name=kata type=text size=17 /><br>
		<select name='kata1'>
...
<option value=2020- >2020</option>
            ...
            while($t=mysql_fetch_array($tampil)){
              echo "<option value='$t[cchl]'>$t[cchl]</option>";
            }
echo "</select>
        >><input type=submit value=Tampil />
      </form>";
...
echo"";
    ...
    elseif ($_SESSION[cv]=='116x'){
        
     
	      
		  echo "<table><tr><td><b><u><font size=2>Cari Spek Bahan Baku (BB) dan Spek Bahan Kemas (BK) :</u></b></font><br><br>
<font size=2>Pilih dan Cari berdasarkan kata kunci <b>Judul atau Kode Dokumen :</b></font>
...
<font size=2><b>Pilih jenis dokumen Spek BB/BK  :</b></font><br>
<select name='kata2'>
            <option value='28' selected>- Pilih Jenis Dokumen -</option>
            <option value='28'>Spesifikasi Bahan Baku</option>
            <option value='29'>Spesifikasi Bahan Kemas</option>";
echo "</select><br>
        >><input type=submit value=Cari />
      </form></td></tr></table><br><br><br><br><br><br><br><br><br>
   ";
...
echo "</select><br>
	...
	<input type=hidden value='$_SESSION[bagianuser]' name='kata'> 
       	           <input type=submit value='Tampilkan Registrasi Dokumen!' />
      </form><form method=POST action='$aksi?module=dokumen&act=caridokumen5' target=_blank>   
	<input type=hidden value='$_SESSION[bagianuser]' name='kata'> 
       	           <input type=submit value='Tampilkan Registrasi Dokumen (tanpa lampiran)' />
      </form>";
...
$kata3 = $_SESSION[bagianuser];
  ...
  echo "<h3>Dokumen yang harus direview bulan : $bln_thn1</h3>";
...
echo "<font size=2><b>Cek dokumen-dokumen dibawah yang harus direview bulan ini di jajaran $_SESSION[bagianuser]. Jika bagian anda memiliki dokumen yang harus direview dibawah ini, silahkan lakukan review dan cek isi dokumen tersebut apakah masih sesuai atau tidak. Bila tidak ada perubahan hubungi dan serahkan dokumen ke MR untuk di lakukan penulisan review pada dokumen controlled bersamaan dengan dokumen master, bila ada perubahan setelah anda review segera lakukan usulan perubahan dokumen (UPD)</b><br><table>
  ...
  $ketemu = mysql_num_rows($hasil);
   ...
   case "pdfdokumen":
    ...
    echo "<object data='http://ekfpb.com/bdg/m/master_pdf/$r[id_jendok]/$r[kode_dok].pdf' type='application/pdf' width='100%' height='100%'>
  ...
  Tapi jangan khawatir anda dapat download file-nya : <a href='../../bdg/master_pdf/$r[id_jendok]/$r[kode_dok].pdf'>Klik disini.</a></p>
  
</object>";
    break;  
  
  case "tambahdokumen":
    echo "<h3>Tambah Dokumen</h3>
...
<tr><td width=70><b>PJ/ Pembuat Dok :</b></td>     <td><input type=text name='pj_dok' size=60 value=''>Asman dan Supervisor!</td></tr>
...
<select name='nama_file'><option value='.docx' selected>.docx (word)</option><option value'.xlsx'>.xlsx (excel)</option></select>
default .docx ganti .xlsx jika excel</td></tr>";
    ...
    echo "<h3>Entry permohonan copy Dokumen</h3>
...
$tgl_sekarang = date("Y-m-d");
 	if ($_SESSION[leveluser]=='Admin'){ 
		  ...
		  <select name='username'>
		   <option value=0 selected>- Pilih Pemohon Copy -</option>";
            ...
            $tampil1=mysql_query("SELECT * FROM users ORDER BY cNama");
    ...
    echo "<h3>Entry/ Buat Usulan Dokumen</h3>
...
if ($_SESSION[leveluser]=='Admin'){ 
 ...
 $tgl_berlaku=tgl_indo1($r[tgl_berlaku]);
   ...
   <tr> <td><b>Tgl Revisi 10 :</b></td><td><input type=text name='tgl_rev10' value='$r[tgl_rev10]' size=20>*)</td></tr>
    ...
    <tr><td><b>Hasil Review 1 :</b></td>  <td><input type=text name='hasil_review1' value='$r[hasil_review1]' size=20>";
    echo"</td></tr>
    <tr><td><b>Tgl Review 2 :</b></td><td><input type=text name='tgl_review2' value='$r[tgl_review2]' size=20></td></tr>
   <tr><td><b>Hasil Review 2 :</b></td>  <td><input type=text name='hasil_review2' value='$r[hasil_review2]' size=20>";
	echo"</td></tr>
	<tr><td><b>Tgl Review 3 :</b></td><td><input type=text name='tgl_review3' value='$r[tgl_review3]' size=20></td></tr>
	   <tr><td><b>Hasil Review 3 :</b></td>  <td><input type=text name='hasil_review3' value='$r[hasil_review3]' size=20>";
	echo"</td></tr>
	
	
	<tr><td><b>Tgl Slesai Review :</b></td><td><input type=text name='tgl_slesai_review' value='$r[tgl_slesai_review]' size=20></td></tr>
	<tr><td><b>Tgl Slesai Review 1 :</b></td><td><input type=text name='tgl_slesai_review1' value='$r[tgl_slesai_review1]' size=20></td></tr>
	<tr><td><b>Tgl Slesai Review 2 :</b></td><td><input type=text name='tgl_slesai_review2' value='$r[tgl_slesai_review2]' size=20></td></tr>
   	<tr><td><b>Tgl Slesai Review 3 :</b></td><td><input type=text name='tgl_slesai_review3' value='$r[tgl_slesai_review3]' size=20></td></tr>
	<tr><td><b>Tgl Real Review :</b></td><td><input type=text name='tgl_real_review' value='$r[tgl_real_review]' size=20></td></tr>
	<tr><td><b>Tgl Review Sebelum :</b></td><td><input type=text name='tgl_review_sebelumnya' value='$r[tgl_review_sebelumnya]' size=20></td></tr>	
	<tr><td><b>Review Terakhir Oleh :</b></td><td><input type=text name='review_oleh' value='$r[review_oleh]' size=20></td></tr>
  ...
  case "distdokumen":
	...
	$datenow = date( 'd-m-Y');
	    ...
	    echo "<h3>Buat Distribusi-Berita Acara-Lembar Info-Sosialisasi Dokumen (All in One)</h3>
...
<tr><td width=70><b>Tgl Buat lembar :</b></td>     <td><input type=text name='tglbuat' size=20 value=$datenow></td></tr>";
            ...
            <option value='' selected>- Pilih Penerima Dokumen 1 -</option>";
			            $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='01. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 2 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='02. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 3 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='03. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 4 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='04. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 5 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='05. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 6 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='06. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 7 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='07. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 8 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='08. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 9 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='09. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 10 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='10. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 11 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='11. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 12 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='12. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 13 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='13. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 14 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='14. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 15 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='15. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 16 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='16. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 17 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='17. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 18 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='18. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 19 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='19. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 20 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='20. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 21 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='21. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 22 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='22. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 23 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='23. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 24 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='24. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 25 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='25. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 26 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='26. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 27 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='27. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 28 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='28. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 29 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='29. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 30 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='30. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo"</select>
	  ...
	  <select name='kata31'>
            <option value='' selected>- Pilih Penerima Dokumen 31 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='31. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 32 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='32. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 33 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='33. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 34 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='34. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 35 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='35. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 36 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='36. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 37 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='37. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 38 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='38. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 39 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='39. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 40 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='40. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo"</select>
	  ...
	  <select name='kata41'>
            <option value='' selected>- Pilih Penerima Dokumen 41 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='41. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 42 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='42. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 43 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='43. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 44 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='44. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 45 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='45. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 46 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='46. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 47 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='47. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 48 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='48. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 49 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='49. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 50 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='50. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo"</select>
	  <select name='kata51'>
            <option value='' selected>- Pilih Penerima Dokumen 51 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='51. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 52 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='52. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 53 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='53. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 54 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='54. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 55 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='55. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 56 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='56. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 57 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='57. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 58 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='58. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 59 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='59. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo "</select>
            ...
            <option value='' selected>- Pilih Penerima Dokumen 60 -</option>";
			                     $tampil=mysql_query("SELECT * FROM users ORDER BY cNama");
            while($r=mysql_fetch_array($tampil)){
              echo "<option value='60. | $r[cNama] ($r[cIdjab])'>$r[cNama] - $r[cIdjab]</option>";
            }
echo"</select>
</td></tr>";
  ...
  echo "<h3>Buat Dokumen Terlampir (Satu Jenis Dokumen dan Revisi Sama !!)</h3>
