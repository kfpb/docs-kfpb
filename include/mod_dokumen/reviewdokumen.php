<div class="navbar navbar-inner block-header">
	<div class="muted pull-left">Review Dokumen Internal</div>
</div>
...
switch($_GET[act]){
   default:
       echo "<h2>Review Dokumen Internal</h2>";
...
echo "</select>
	   ...
	   echo "<br><font size=2><br>Tampilkan dalam browser <br> (hanya untuk pembanding memastikan jumlah yang direview berdasarkan bulan tgl berlaku/review terakhir sama dengan tgl harus review)<br><b>Dokumen tgl berlaku terakhir </b> pada bulan:</b></font>
...
echo"";
    ...
    if ($_SESSION[leveluser]=='Admin'){
      ...
      $kata = trim($_SESSION[bagian]) ;
	     ...
	     // Cari dokumen yang harus direview
	 echo "<font size=2><b>DAFTAR DOKUMEN yang harus di Review Bulan & tahun (<b><u>ENTRY HASIL REVIEW!</u></b>) oleh $_SESSION[bagianuser] </b> : </font><br>
	 <form method=POST action='$aksi?module=dokumen&act=caridokumenreview2' target=_blank>      
 <select name='kata'>
             <option value=0 selected>- Pilih Bulan -</option>
            <option value=01 >Januari</option>
            <option value=02 >Februari</option>
...
<select name='kata1'>
	 ...
	 // Cari dokumen yang harus direview
	 echo "<font size=2><b>Dokumen yang telah di Review Bulan & tahun yang dipilih</b> oleh $_SESSION[bagianuser]  : </font><br>
	 <form method=POST action='$aksi?module=dokumen&act=caridokumenreview00' target=_blank>      
 <select name='kata'>
             <option value=0 selected>- Pilih Bulan -</option>
            <option value=01 >Januari</option>
            <option value=02 >Februari</option>
