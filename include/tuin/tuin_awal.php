...
<fieldset>
<legend>Edit Surat Penawaran</legend>
	<div class="control-group">
...
<? } ?>
    ...
    <div class="control-group">
		<label class="control-label" for="status">Status Selesai</label>
        <div class="controls">
            <?
            if ($e[istatus2]=="Y") {
             echo"
            <select id=istatus2 class=chzn-select name='statusku'>
...
<table width="100%" border=1>
    ...
    <tr><td>Kepada</td><td>: <strong>Sub Bagian Pengadaan (<?=$e[cNama];?>)</strong></td></tr>
