...
SPD-MR<br>
 	...
 	<div class="control-group">
    	<label class="control-label" for="fileInput">Scan Lembar Dist</label>
        <div class="controls">
        	<input class="input-file uniform_on" id="fileInput" type="file" name="fupload">
        </div>
    </div>
...
<table width="100%" border=1>
	...
	<tr><td>Lampiran File</td><td>: <a title="Lampiran" href="distribusidok/<?=$e[difile];?>">Klik Disini (Jika Ada)</a></td></tr>
    <tr><td>File Dokumen PDF</td><td>: <a target=_blank href="../../m/master_pdf/<?=$r[id_jendok];?>/<?=$r[kode_dok];?>.pdf">Klik Disini!</a></td></tr>
...
<iframe src="../../m/master_pdf/<?=$r[id_jendok];?>/<?=$r[kode_dok];?>.pdf" width=100% height=100%></iframe>
<br />
