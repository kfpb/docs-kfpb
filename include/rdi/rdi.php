<div class="navbar navbar-inner block-header">
	<div class="muted pull-left">Rekap Disposisi</div>
</div>
...
?>
<form method="post" action="include/rdi/lrdi.php" enctype="multipart/form-data" class="form-horizontal">
<fieldset>
<legend>Filter Disposisi</legend>
