	...
	<?
		...
		while($s = mysql_fetch_array($pesanan)) {
			...
			echo "
                ...
                <td class='center'>
                    <a href='include/spptek/aksi_sinter.php?act=hapuspesanbrg&kode=$s[id_pesanantek]' onClick=\"return confirm('Yakin ingin menghapus??')\" class='btn btn-warning'>Hapus</a>";
            echo"</td>
                </tr>";
				$i++;
	    }
