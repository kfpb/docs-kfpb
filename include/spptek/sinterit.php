<div class="navbar navbar-inner block-header">
	<div class="muted pull-left">Buat Tiket Aplikasi Sistem IT (Permintaan Pembuatan & Perbaikan)</div>
</div>
...
<fieldset>
<legend>Buat Tiket Aplikasi Sistem IT</legend>
...
?>
	...
	<div class="control-group">
        ...
        <div class="controls">
            <input type=hidden name=jenisms value='999'><b>Tiket Aplikasi Sistem IT</b>
        </div> 
	</div>
	...
	<div class="control-group">
        ...
        <div class="controls">
            ...
            <option value='pembuatan'>Pembuatan Aplikasi/Sistem</option>   
            <option value='perbaikan'>Perbaikan/Pengembangan Sistem/Aplikasi</option>  
            <option value='database'>Database</option>
            <option value='lainnya'>Sistem IT Lainnya</option>
            </option>
            </select></b>
        </div> 
	</div>
...
<b>Penjelasan Permintaan (Alur Proses, Spesifikasi dll)</b> : ...<br><br>

<b>Personil yang bisa dihubungi </b> : ...<br><br>

<br><b>Catatan :</b><br> 
- Jika permintaan aplikasi sistem IT ini merubah bisnis proses plant, harap membuat Usulan ChangeControl terlebih dahulu.<br>
- Jika permintaan aplikasi sistem baru, wajib lampirkan Bisnis-Alur Proses/Flow Chart, sistem/fitur dan Database-nya (Kolom-kolom data di excel)<br><br>
...
<fieldset>
<legend>Edit Permohonan Tiket Aplikasi Sistem IT</legend>
	<?
if($_SESSION[levelcv]<1 OR $_SESSION[cv]=='75'){
?>
    <div class="control-group">
...
?>
	...
	<div class="control-group">
        ...
        <div class="controls">
            ...
            <option value='pembuatan'>Pembuatan Sistem/ Aplikasi</option>   
            <option value='perbaikan'>Perbaikan Sistem/Aplikasi</option>  
            <option value='database'>Database</option>
    ...
    <div class="control-group">
    	<label class="control-label" for="ket">Isi Permintaan Aplikasi Sistem IT (Tekan Shift+Enter untuk pindah baris)</label>
        <div class="controls">
...
<?php
	...
	?>
<strong>
<legend>Detail Tiket Aplikasi Sistem IT</legend>
...
<div class="span12">
	...
	<button class="btn-info btn-large" onclick="window.location.href='?pages=sinterit&act=tambah3'">Buat Tiket Aplikasi </button><br /><b>*Apabila pembuatan/perubahan merubah bisnis proses plant, harap membuat usulan Change Control terlebih dahulu</b><br />
	...
	<?
		...
		<td>";echo tgl_indo($s[sitgl]);echo"</td>
				...
				if ($s[sstatus]=='N'){
					...
					{
			echo "<td><a href='include/sinter/aksi_sinter.php?act=acc5&id=$s[siid]' onClick=\"return confirm('Yakin akan ACC/kirim Permintaan Aplikasi Sistem IT ini??')\" class='btn btn-info'>ACC/Kirim!</a></td>
			<td class='center'><a href='include/sinter/aksi_sinter.php?act=hapus&id=$s[siid]' onClick=\"return confirm('Yakin ingin menghapus??')\"><i class='icon-trash'></i></a></td><td> 
				<a href='?pages=sinterit&act=edit&id=$s[siid]' class='btn btn-info'>Koreksi/Komen</a></td><td><a href='home.php?pages=sinterit&act=detail&id=$s[siid]' class='btn btn-info'>Detail</a></td><td>
					...
					{
			echo "<td><a href='include/sinter/aksi_sinter.php?act=acc2&id=$s[siid]' onClick=\"return confirm('Yakin akan ACC/kirim Permintaan Aplikasi Sistem IT ini??')\" class='btn btn-info'>ACC !</a></td>
			<td class='center'><a href='include/sinter/aksi_sinter.php?act=hapus&id=$s[siid]' onClick=\"return confirm('Yakin ingin menghapus??')\"><i class='icon-trash'></i></a></td><td> 
				<a href='?pages=sinterit&act=edit&id=$s[siid]' class='btn btn-info'>Koreksi/Komen</a></td><td><a href='home.php?pages=sinterit&act=detail&id=$s[siid]' class='btn btn-info'>Detail</a></td><td>
				</td>";
					}
			...
			echo "<td>
			<a href='include/sinter/aksi_sinter.php?act=acc5&id=$s[siid]' onClick=\"return confirm('Yakin akan ACC/kirim permintaan Aplikasi Sistem IT ini??')\" class='btn btn-info'>ACC/Kirim!</a>
			     </td>";
						}
						else {
			echo "<td>
...
<br><br>
	...
	<h5>Baris Tabel Berwarna <u>HIJAU</u> = <strong><u>KONSEP Permintaan Aplikasi Sistem IT BELUM TERKIRIM/ACC!</u>,<br>
	Klik di Kolom <u>Detail (D)</u> untuk Melihat Isi/Detail Permintaan Aplikasi Sistem IT,<br>
	...
	Untuk ACC atau Kirim permintaan Aplikasi Sistem IT Klik Link di kolom Status : <u>ACC/KIRIM !</u></h5></strong>
