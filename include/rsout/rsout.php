<div class="navbar navbar-inner block-header">
	<div class="muted pull-left">Rekap Surat Keluar</div>
</div>
...
?>
<form method="post" action="include/rsout/lrsout.php" enctype="multipart/form-data" class="form-horizontal">
<fieldset>
<legend>Filter Surat Keluar</legend>
