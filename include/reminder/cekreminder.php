<div class="navbar navbar-inner block-header">
	<div class="muted pull-left">Reminder Expire Dokumen</div>
</div>
...
$aksis="../../include/mod_dokumen/dokumen.php";
$aksi1="../../include/mod_upd/aksi_upd.php";
$aksi2="../../include/mod_pcopy/aksi_copy.php";
switch($_GET[act]){
   default:
       echo "<h2>Reminder Expire Dokumen</h2>";
...
// Tambah dokumen
	     ...
	     // Cari dokumen yang harus direminder
	 echo "<font size=2><font color=blue style='background-color:#FFFFFF'><b><u>Tampil Dokumen yang harus di reminder</u></b></font> : </font><br>";
	 
	  echo "<font size=2><br>Tampilkan dalam browser <b>Dokumen yang harus di reminder </b> pada bulan:</b></font>
<form method=POST action='$aksi?module=dokumen&act=caridokumenreminder' target=_blank>      
 <select name='kata'>
...
<select name='kata1'>
	    ...
	    // Cari dokumen yang harus direminder per PJ DOK
	 echo "<font size=2><font color=blue style='background-color:#FFFFFF'><b><u>Tampilkan Dokumen Halal yang Expire pada bulan</u></b></font> : </font><br>";
	 
	  echo "<font size=2><br>Tampilkan dalam browser <b>Dokumen yang harus di reminder</b> pada bulan:</b></font>
<form method=POST action='$aksi?module=dokumen&act=caridokumenreminder4' target=_blank>      
 <select name='kata'>
             <option value=0 selected>- Pilih Bulan -</option>
            <option value=01 >Januari</option>
            <option value=02 >Februari</option>
...
echo "</select>
	   ...
	   echo "<br><font size=2><br>Tampilkan dalam browser <br> (hanya untuk pembanding memastikan jumlah yang direminder berdasarkan bulan tgl berlaku/reminder terakhir sama dengan tgl harus reminder)<br><b>Dokumen tgl berlaku terakhir </b> pada bulan:</b></font>
<form method=POST action='$aksi?module=dokumen&act=caridokumenreminder3' target=_blank>      
 <select name='kata'>
             <option value=0 selected>- Pilih Bulan -</option>
            <option value=01 >Januari</option>
            <option value=02 >Februari</option>
...
<select name='kata1'>
	    ...
	    echo "<font size=2><br>Tampilkan LAPORAN dalam browser <b>Dokumen yang TELAH di reminder </b> pada bulan:</b></font>
<form method=POST action='$aksi?module=dokumen&act=caridokumenreminder0' target=_blank>      
 <select name='kata'>
             <option value=0 selected>- Pilih Bulan -</option>
            <option value=01 >Januari</option>
            <option value=02 >Februari</option>
...
echo"";
    ...
    if ($_SESSION[leveluser]=='Admin'){
      ...
      $kata = trim($_SESSION[bagian]) ;
	     ...
	     // Cari dokumen yang harus direminder
	 echo "<font size=2><b>DAFTAR DOKUMEN yang harus di reminder Bulan & tahun (<b><u>ENTRY HASIL reminder!</u></b>) oleh $_SESSION[bagianuser] </b> : </font><br>
	 <form method=POST action='$aksi?module=dokumen&act=caridokumenreminder2' target=_blank>      
 <select name='kata'>
             <option value=0 selected>- Pilih Bulan -</option>
            <option value=01 >Januari</option>
            <option value=02 >Februari</option>
...
<select name='kata1'>
	 ...
	 // Cari dokumen yang harus direminder
	 echo "<font size=2><b>Dokumen yang telah di reminder Bulan & tahun yang dipilih</b> oleh $_SESSION[bagianuser]  : </font><br>
	 <form method=POST action='$aksi?module=dokumen&act=caridokumenreminder00' target=_blank>      
 <select name='kata'>
             <option value=0 selected>- Pilih Bulan -</option>
            <option value=01 >Januari</option>
            <option value=02 >Februari</option>
...
// -------------------------------------------------------------------------------------------reminder DOKUMEN
  case "reminderdokumen":

  $bln_thn =tgl_indo1($bln_thn_sekarang);
   $bln_thn1 =tgl_indo($bln_thn_sekarang);
$kata3 = $_SESSION[bagianuser];

  echo "<h2>Dokumen yang harus direminder bulan : $bln_thn1</h2>";
	
echo "<font size=2><b>Cek dokumen-dokumen dibawah yang harus direminder bulan ini di jajaran $_SESSION[bagianuser]. Jika bagian anda memiliki dokumen yang harus direminder dibawah ini, silahkan lakukan reminder dan cek isi dokumen tersebut apakah masih sesuai atau tidak. Bila tidak ada perubahan hubungi dan serahkan dokumen ke MR untuk di lakukan penulisan reminder pada dokumen controlled bersamaan dengan dokumen master, bila ada perubahan setelah anda reminder segera lakukan usulan perubahan dokumen (UPD)</b><br><table>
          <tr><th>No</th><th>Kode Dok</th><th>Judul Dok</th><th>Tgl reminder</th></tr>";
  ...
  $jml_kata = $jml_katakan-1;
    ...
    for ($i=0; $i<=$jml_kata; $i++){
      $cari .= "tgl_reminder LIKE '%$pisah_kata[$i]%'";
      if ($i < $jml_kata ){
        $cari .= " OR ";
      }
    }
  ...
  $ketemu = mysql_num_rows($hasil);
		...
		echo "<font size=2><br>Total Dokumen yang harus di reminder : $jmldata";
	   
    $no = $posisi+1;
    while($r=mysql_fetch_array($hasil)){
	
    $tgl_reminder=tgl_indo($r[tgl_reminder]);
     
      echo "
	  <tr><td>$no</td>
				<td width=60>$r[kode_dok]</td>
                <td width=200>$r[judul_dok]</td>
				<td width=100>$tgl_reminder</td></tr>";
			$no++;
	  }
...
<center><font size=2><b><a href=media.php?module=dokumen><--Kembali</a></p></b></center>";
   ...
   case "detaildokumen":
    ...
    echo "<h2>Detail Dokumen</h2>
      ...
      $tgl_reminder=tgl_indo($r[tgl_reminder]);
	  $tgl_reminder1=tgl_indo($r[tgl_reminder1]);
	  $tgl_reminder2=tgl_indo($r[tgl_reminder2]);
	  $tgl_reminder3=tgl_indo($r[tgl_reminder3]);
	...
	<td><b>Tgl Revisi 15 :</b></td><td>$tgl_rev15</a></td></tr>
				  ...
				  <tr><td><b>Tgl reminder 1 :</b> </td><td>$tgl_reminder1</td></tr>
				  <tr><td><b>Hasil reminder 1 :</b> </td><td>$r[hasil_reminder1]</td></tr>
				  <tr><td><b>Tgl reminder 2 :</b> </td><td>$tgl_reminder2</td></tr>
				  <tr><td><b>Hasil reminder 2 :</b> </td><td>$r[hasil_reminder2]</td></tr>
				  <tr><td><b>Tgl reminder 3 :</b> </td><td>$tgl_reminder3</td></tr>
				  <tr><td><b>Hasil reminder 3 :</b> </td><td>$r[hasil_reminder3]</td></tr>
				  <tr><td><b>reminder terakhir oleh :</b> </td><td>$r[reminder_oleh]</td></tr>
				    <tr><td><b>Tgl Maks reminder selanjutnya :</b> </td><td>$tgl_reminder</td></tr>
...
if ($_SESSION[leveluser]=='Admin'){ 
 ...
 $tgl_berlaku=tgl_indo1($r[tgl_berlaku]);
   ...
   <tr> <td><b>Tgl Revisi 10 :</b></td><td><input type=text name='tgl_rev10' value='$r[tgl_rev10]' size=20>*)</td></tr>
	...
	<tr><td><b>Tgl reminder :</b></td><td><input type=text name='tgl_reminder' value='$r[tgl_reminder]' size=20>Maks reminder selanjutnya</td></tr>
	<tr><td><b>Penerima Dokumen :</b></td><td>$r[cchl]</td></tr>";
 ...
 $tgl_berlaku=tgl_indo1($r[tgl_berlaku]);
   ...
   <tr> <td><b>Tgl Revisi 10 :</b></td><td><input type=text name='tgl_rev10' value='$r[tgl_rev10]' size=20>*)</td></tr>
	...
	<tr><td><b>Tgl reminder :</b></td><td><input type=text name='tgl_reminder' value='$r[tgl_reminder]' size=20>Maks reminder selanjutnya (Edit Manual!)</td></tr>
	<tr><td><b>Tgl reminder 1 :</b></td><td><input type=text name='tgl_reminder1' value='$r[tgl_reminder1]' size=20></td>
    <tr><td><b>Hasil reminder 1 :</b></td>  <td><select name='hasil_reminder1'>";
 
          if ($r[hasil_reminder1]==''){
            echo "<option value='' selected>Belum ada hasil reminder</option>
			<option value='Ada Perubahan'>Ada Perubahan</option>
			<option value='Tidak ada Perubahan'>Tidak ada Perubahan</option>
			";
          }   
         if ($r[hasil_reminder1]=='Ada Perubahan'){
            echo "<option value='' selected>Belum ada hasil reminder</option>
		   ...
		   if ($r[hasil_reminder1]=='Tidak ada Perubahan'){
            echo "<option value=''>Belum ada hasil reminder</option>
			<option value='Ada Perubahan' selected>Ada Perubahan</option>
	...
	echo"</td></tr>
    <tr><td><b>Tgl reminder 2 :</b></td><td><input type=text name='tgl_reminder2' value='$r[tgl_reminder2]' size=20></td></tr>
   <tr><td><b>Hasil reminder 2 :</b></td>  <td><select name='hasil_reminder2'>";
 
          if ($r[hasil_reminder2]==''){
            echo "<option value='' selected>Belum ada hasil reminder</option>
			<option value='Ada Perubahan'>Ada Perubahan</option>
			<option value='Tidak ada Perubahan'>Tidak ada Perubahan</option>
			";
          }   
         if ($r[hasil_reminder2]=='Ada Perubahan'){
            echo "<option value='' selected>Belum ada hasil reminder</option>
			<option value='Ada Perubahan' selected>Ada Perubahan</option>
			<option value='Tidak ada Perubahan'>Tidak ada Perubahan</option>
			";
		   ...
		   if ($r[hasil_reminder2]=='Tidak ada Perubahan'){
            echo "<option value=''>Belum ada hasil reminder</option>
			<option value='Ada Perubahan' selected>Ada Perubahan</option>
			<option value='Tidak ada Perubahan' selected>Tidak ada Perubahan</option>
			";
	...
	echo"</td></tr>
	<tr><td><b>Tgl reminder 3 :</b></td><td><input type=text name='tgl_reminder3' value='$r[tgl_reminder3]' size=20></td></tr>
	   <tr><td><b>Hasil reminder 3 :</b></td>  <td><select name='hasil_reminder3'>";
 
          if ($r[hasil_reminder3]==''){
            echo "<option value='' selected>Belum ada hasil reminder</option>
			<option value='Ada Perubahan'>Ada Perubahan</option>
			<option value='Tidak ada Perubahan'>Tidak ada Perubahan</option>
			";
          }   
         if ($r[hasil_reminder3]=='Ada Perubahan'){
            echo "<option value='' selected>Belum ada hasil reminder</option>
			<option value='Ada Perubahan' selected>Ada Perubahan</option>
			<option value='Tidak ada Perubahan'>Tidak ada Perubahan</option>
			";
		   ...
		   if ($r[hasil_reminder3]=='Tidak ada Perubahan'){
            echo "<option value=''>Belum ada hasil reminder</option>
			<option value='Ada Perubahan' selected>Ada Perubahan</option>
			<option value='Tidak ada Perubahan' selected>Tidak ada Perubahan</option>
			";
