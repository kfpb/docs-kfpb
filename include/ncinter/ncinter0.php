<div class="navbar navbar-inner block-header">
	<div class="muted pull-left">Registrasi Penyimpangan (ALL)</div>
</div>
...
<fieldset>
<legend>Buat Penyimpangan</legend>
<?
if($_SESSION[levelcv]<2){
?>
  <div class="control-group">
		<label class="control-label" for="ns">Nomor nc </label>
...
?>
  ...
  <div class="control-group">
      ...
      <div class="control-group">
   	...
   	<div class="control-group">
    	<label class="control-label" for="fileInput">Lampiran nc/Kajian Risiko</label>
        <div class="controls">
...
<input class="input-medium focused" id="ns" type="hidden" name="nomor" value="<?=$e[ncnmr];?>">
	<div class="control-group">
		<label class="control-label" for="ns">Nomor nc Manual</label>
        <div class="controls"><input class="input-medium focused" id="ns" type="text" name="nomor1" value="<?=$e[ncnmr1];?>"></div>
    </div>
	<div class="control-group">
		<label class="control-label" for="tgl">Tanggal</label>
        <div class="controls"><input class="input-small datepicker" id="tgl" type="text" name="tgl" value="<?=$e[nctgl];?>" required="required"></div>
    </div>
...
<input  type="hidden" name="status2" value="Open">
 ...
 <div class="control-group">
		<label class="control-label" for="tgl">Tanggal</label>
        <div class="controls"><input type="hidden" name="tgl" value="<?=$e[nctgl];?>" required="required"><? echo tgl_indo($e[nctgl]); ?></div>
    </div>
 ...
 <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="control-group">
 	...
 	<div class="control-group">
    	<label class="control-label" for="fileInput">Lampiran nc/Risiko</label>
        <div class="controls">
...
<legend>Jawab Penyimpangan yang perlu diperbaiki</legend>
 <div class="control-group">
    ...
    <div class="control-group">
 	...
 	<div class="control-group">
    	<label class="control-label" for="fileInput">Lampiran nc/Risk</label>
        <div class="controls">
...
<table width="100%" border=1>
	<tr><td width="24%">Nomor nc </td><td>: <?=$e[ncnmr1];?></td></tr>
	...
	<tr><td>Usulan dari</td><td>: <strong><?=$ef[cNama];?> (<?=$ef[cJabatan];?>), <?=$e[cNama];?> (<?=$e[cJabatan];?>)</strong></td></tr>
	...
	<tr><td>Lampiran nc/Risiko </td><td><a href='ncp/<? echo"$e[ncfile]"; ?>'>: File</a></td></tr>
...
<?php
	$psn = mysql_query("SELECT a.cUser,a.cNama,a.cJabatan, a.cFoto, a.cJabatan,b.tgl_baca FROM users a
...
<?php
	$psn = mysql_query("SELECT a.cUser,a.cNama, a.cJabatan, a.cFoto,b.tgl_baca FROM users a
...
<br><br>
<? echo"<a href='home1.php?pages=ncinter&act=print&id=$e[ncid]' class='btn btn-info pull-right target=_blank'><i class='icon-print'></i> Cetak</a><br>";?>
...
<?
echo"Lampiran Rencana Tindakan nc : <a href='ntnc/$edf[disfile]'>klik disini (jika ada)</a>";
?>
...
while ($t=mysql_fetch_array($pds)){
	...
	if ($t[psacc]=="N"){
		...
		echo "<tr class='info'>
				...
				<td>$t[kepada] ($t[kepadajab])</td>
				<td>$t[pInstruksi]</td>
				<td>$t[info]Lampiran : <a href='jwb_ntnc/$t[filedis]'>Jika ada Klik disini</a></td>
				<td><b>Tgl Baca:</b><br> $tglBaca<br><b>Tgl Slesai:<br></b> $tglSelesai</td>
			 </tr>";
	}
}
...
<?	$e = mysql_fetch_array(mysql_query("SELECT a.*, b.cNama, b.cJabatan FROM ncinter a,users b WHERE a.ncpengirim1=b.cId AND a.ncid='$_GET[id]'"));
	...
	$efgh = mysql_fetch_array(mysql_query("SELECT a.*, b.cNama, b.cJabatan FROM ncinter a,users b WHERE a.ncpengirim2=b.cId AND a.ncid='$_GET[id]'"));
?>
<? echo"<a href='home1.php?pages=ncinter2&act=print&id=$e[ncid]' class='btn btn-info pull-right' target=_blank><i class='icon-print'></i> Cetak RTL</a><br>";?>
...
<div>
<div class="span12">
<?php echo"<a href='home2.php?pages=ncinter5' class='btn btn-suncess'>Export XLS</a>" ?>
	<?php
		$smasuk = mysql_query("SELECT * FROM ncinter where accsipengirim1='Y' AND `show`='Y' ORDER BY nctgl DESC");
	...
	<?
		...
		echo "  <td></td><td>";echo tgl_indo($s[nctgl]);echo"</td>
				...
				<td><font size=1>$s[ncnmr1]</font></td>
				<td>$p[cJabatan]</td>
			    <td><font size=1>$j[nama_jnc]</font></td>
			    <td><font size=1>$s[ncperihal1]</font></td>
				...
				if ($s[ncstatus]=='N'){
					...
					{
			echo "<td><a href='home.php?pages=ncinter&act=detail&id=$s[ncid]' class='btn btn-info'>Detail</a>
				</td>";
					}
...
if($_SESSION[levelcv]<2){
			...
			echo "<td><b>Diterima Pnc</b><br><b>($s[ncstatus2])</b>";
			
				echo "
				<td class='center'><a href='home.php?pages=ncinter&act=detail&id=$s[ncid]' class='btn btn-info'>Detail</a></td>
				</td>
				</tr>";	
				}
				else {
					echo "<td><b>Diterima Pnc ($s[ncstatus2])</b></td>";
