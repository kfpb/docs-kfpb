...
// 		$udmasuk = mysql_query("SELECT a.*, b.cNama, b.cIdjab FROM udokumen a, users b WHERE a.udpengusul=b.cId AND a.udstatus1='N' ORDER BY a.udtgl DESC");
		$udmasuk = mysql_query("SELECT a.*, b.cNama, b.cIdjab FROM udokumen a, users b WHERE a.udpengusul=b.cId AND a.udstatus='Y' AND a.ccstatus='Y' ORDER BY a.udtgl DESC");	
