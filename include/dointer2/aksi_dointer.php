...
Admin E-kfpb (Firman)
");
if($mail->Send()) echo "<center><h4>Memo/Undangan berhasil tersimpan dan email terkirim ke atasan langsung, <br><a href=../../home.php?pages=dointer>KLIK DISINI</a> untuk kembali!
</h4></center>";
else echo "<center><h4>Memo/Undangan berhasil tersimpan tetapi email ke atasan langsung gagal terkirim, <br><a href=../../home.php?pages=dointer>KLIK DISINI</a> untuk kembali!
</h4></center>";

echo"
<script>
        var timer = setTimeout(function() {
            window.location='../../home.php?pages=dointer'
        }, 3000);
</script>";
*/
