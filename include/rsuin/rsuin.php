<div class="navbar navbar-inner block-header">
	<div class="muted pull-left">Rekap Surat Masuk</div>
</div>
...
?>
<form method="post" action="include/rsuin/lrsuin.php" enctype="multipart/form-data" class="form-horizontal">
<fieldset>
<legend>Filter Surat Masuk</legend>
