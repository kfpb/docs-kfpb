...
<div>
<div class="span12">
<form method="post" action="?pages=usrdrvw_admin">
<b>Pilih Bulan & Tahun : </b>
<select id="bulan" class="chzn-select span2" name="bulan" required="required">
...
<select id="tahun" class="chzn-select span2" name="tahun" required="required">
