...
if (empty($_SESSION[username]) AND empty($_SESSION[passuser])){
 ...
 <center>Anda tidak punya akses ! dan atau untuk mengakses PDF ini, Anda harus login <br>";
...
//<iframe width='100%' height='100%' src='http://ekfpb.com/bnj/new/web/viewer.html?file=/m/master_pdf/$r[id_jendok]/$r[kode_dok].pdf'></iframe>
}
