...
?>
                    ...
                    <?php
						...
						elseif($_GET[pages]=="copy_ebr"){
							include"include/copy_ebr/copy_ebr.php";		//daftar permohonan EBR (redirect ke dinterebr)
						}
